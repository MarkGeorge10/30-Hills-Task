class UserSingleton {
  ...
  static UserSingleton instance = new UserSingleton();
  ...
  int searchById(List<UserSingleton> user, int id) {
  ...
  List<int> find_Friends_Friends(
      List<UserSingleton> user, List<dynamic> friends, int userID) {
